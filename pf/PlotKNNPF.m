...
[binDims,nnn,dthresh,type,distdw,distIndw,bound_lims] = DefaultArgs(varargin,{50,70,.5*Session.xyz.sampleRate,'xy',[],[],[]});
...
if size(distdw,1)>nnn,
    ...
    RateMap = permute(nanmean(smywut(1:nnn,:,:,:),1),[3,2,1]);
