...
%jg05-20120310.DetectGammaBursts3.lfpinterp.all.1-96.mat
...
% $$$             bmp(f,i-64,r,t) = circ_mean(ds.BurstThetaPhase(bselind,r));
% $$$             bsp(f,i-64,r,t) = circ_std(ds.BurstThetaPhase(bselind,r));
...
subplot(1,numel(pchans),r);
    imagesc(mean(freqRange,2),channels,bmp(:,:,r)');
colormap hsv
end
