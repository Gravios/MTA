...
[yg, fg,  phig, yerrg, phierrg, phlocg,powg] =  mtptchd(wrhm,Trial.spk.res, Trial.spk.clu, 2^9,rhm.sampleRate,2^7,2^7*.875,3,'linear',[],[1,30],[],Trial.stc{'h',rhm.sampleRate}.data,[],10);
...
pfl = MTAApfs(Trial,[],'lswalk',true);
pfg = MTAApfs(Trial,[],'hswalk',true);
pfr = MTAApfs(Trial,[],'rear',true);
