function [pfs] = compute_egoradial_ratemap(Trial,units,xyz,spk,pft,thetaRefChan,rot,hbaCorrection,phzCorrection,overwrite)
...
% CHECK existence of pfs object
    ...
    filepath = fullfile(Trial.spath,...
                        [Trial.filebase,'.Pfs.egofield_hba_radial_theta_phase_',num2str(phase),'.mat']);
