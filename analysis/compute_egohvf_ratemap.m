function [pfs] = compute_egohvf_ratemap(Trial,units,xyz,spk,pft,rot,hbaCorrection,thetaPhzChan,phzCorrection,headCenterCorrection,overwrite)
...
pargs.units        = units;
pargs.tag          = 'egofield';
pargs.binDims      = [20, 20, 20];                           % X Y HBA
...
% CHECK existence of pfs object
    pargs.tag = ['egofield_theta_phase_hvf_',num2str(phase),stag];
