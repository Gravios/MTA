...
[units, get_featureSet, sampleRate, pft, pfsArgs, threshRate,               ...
 threshDist, overwrite, purge] =                                            ...
...
dper = MTADepoch([], [],                                                    ...
                 abs(drz(:,u))<threshRate & ddz(:,u)<threshDist,            ...
