...
if exist(filepath,'file'),
    ...
    vbi = {};
    shifts = 0:8:2^8;
    sJpdf =  zeros([numel(ferrorBinCenters{1}),numel(phzBinCenters),nbins, nbins, nbins, 2, nvars, nvars, nvars, numel(stgrps),numel(stgrps),nIter]);
                    ...
                    for d = h+1:nvars,
                        ...
                        for e = 1:2;
                            ...
                            for x = 1:xc,
                                for y = 1:yc,
                                    for z = 1:zc
disp(['s: ',num2str(s),'  b: ',num2str(b),'   g: ',num2str(g),'   h: ',num2str(h),'   d: ',num2str(d),['   ' ...
                    'x: '],num2str(x),'  y: ',num2str(y),'  z: ',num2str(z),'  e: ',num2str(e)]);
for i = 1:nIter
                                        indb = xi==x & yi==y & zi==z & circshift(tsmMask, randsample(shifts,1)) & tind;
