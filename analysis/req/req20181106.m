function pfs = req20181106(varargin)
%
...
% SET Meta Data
tag = ['hbpptbpFS1v',version];
dataFilePath = fullfile(MTA_PROJECT_PATH,'analysis',...
                   ['req20181106-meta-',...
                    DataHash({sessionListName,version,sampleRate,stcMode,states,func2str(fcn)}),...
                    '.mat']);
...
for t = 1:numel(SessionList),
    ...
    if ~strcmp(stcMode,Trial.stc.mode),  Trial.load('stc',stcMode);  end
    ...
    pchb = feval(feature_fcn,Trial,sampleRate,false,'trb');
    ...
    pfs.save();
    save(dataFilePath,'version','sessionListName','sampleRate','stcMode','states');
