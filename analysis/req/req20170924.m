...
Trials{end+1} = 'jg05-20120309.cof.all';
anatGrpSWPCenter{end+1}(1:5) = nan;
anatGrpSWPCenter{end}(6) = 1;
anatGrpSWPCenter{end}(7) = 1.5;
anatGrpSWPCenter{end}(8) = 1;
anatGrpSWPCenter{end}(9) = 3.5;
anatGrpSWPCenter{end}(10) = 11.5;
anatGrpSWPCenter{end}(11:13) = nan;

Trials{end+1} = 'jg05-20120310.cof.all';
anatGrpSWPCenter{end+1}(1:5) = nan;
anatGrpSWPCenter{end}(6) = 1;
anatGrpSWPCenter{end}(7) = 4.5;
anatGrpSWPCenter{end}(8) = 2;
anatGrpSWPCenter{end}(9) = 3.5;
...
Trials{end+1} = 'jg05-20120312.cof.all';
anatGrpSWPCenter{end+1}(1:3) = nan;
anatGrpSWPCenter{end}(4) = -4.5; % +2 greater than chan count estimate 
anatGrpSWPCenter{end}(5) = -1;  % +1 greater than chan count estimate  
anatGrpSWPCenter{end}(6) = 3.5;
anatGrpSWPCenter{end}(7) = 5;
anatGrpSWPCenter{end}(8) = 4.5;
anatGrpSWPCenter{end}(9) = 3;
anatGrpSWPCenter{end}(10) = 4;
anatGrpSWPCenter{end}(11:12) = nan;


Trials{end+1} = 'jg05-20120315.cof.all';
anatGrpSWPCenter{end+1}(1:4) = nan;
anatGrpSWPCenter{end}(5) = -7;  % +1 greater than chan count estimate  
anatGrpSWPCenter{end}(6) = -2.5;
anatGrpSWPCenter{end}(7) = 2;
anatGrpSWPCenter{end}(8) = 5.5;
anatGrpSWPCenter{end}(9) = 1;
anatGrpSWPCenter{end}(10) = 3;
anatGrpSWPCenter{end}(11:12) = nan;

Trials{end+1} = 'jg05-20120316.cof.all';
anatGrpSWPCenter{end+1}(1:4) = nan;
anatGrpSWPCenter{end}(5) = -6;  % +1 greater than chan count estimate  
anatGrpSWPCenter{end}(6) = 1.5;
anatGrpSWPCenter{end}(7) = 4;
anatGrpSWPCenter{end}(8) = 5.5;
anatGrpSWPCenter{end}(9) = 1;
anatGrpSWPCenter{end}(10) = 3;
anatGrpSWPCenter{end}(11:12) = nan;
...
Trials{end+1} = 'jg05-20120317.cof.all';
anatGrpSWPCenter{end+1}(1:5) = nan;
anatGrpSWPCenter{end}(6) = 5.5;
anatGrpSWPCenter{end}(7) = 2;
anatGrpSWPCenter{end}(8) = 1;
anatGrpSWPCenter{end}(9) = 2;
anatGrpSWPCenter{end}(10) = 4;
anatGrpSWPCenter{end}(11:12) = nan;
...
for t = 1:numel(Trials),
    units{t}(ismember(units{t},unitsBad(unitsBad(:,1)==t,2))) = [];
end
...
states = {'lloc+lpause&theta','hloc+hpause&theta','rear&theta'};
...
meanUnitRates = cf(@(w,r)  (w+r)./2,         maxUnitRates(:,2),maxUnitRates(:,3));
rateRatio    = cf(@(w,r)  (w-r)./(w+r),      maxUnitRates(:,2),maxUnitRates(:,3));
unitDepths   = cf(@(a,u)  a(u),                       allUnitDepths,units);
elnum        = cf(@(p)    p.data.el',                  pfkbs(:,1));
%spInfo       = cf(@(p)    p.data.el',                 pft;

xur = reshape(cat(1,maxUnitRates{:}),numel(states),[])';
en = cat(1,elnum{:});
...
%ind = xur(:,3)<1;
figure,hold on
plot(rr(ind)+randn(size(rr(ind)))/40,ud(ind)+randn(size(ud(ind)))*4,'b.')
