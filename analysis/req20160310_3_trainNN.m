function req20160310_3_trainNN(Trial)
    ...
    for f = 1:round(numel(sbind)/2),%numel(sbind),    
        ...
        [mpn.Stc,mpn.d_state,mpn.labelingStats, ...
         mpn.labelingStatsMulti,mpn.model,mpn.p_state] = ...
            bhv_nn_multi_patternnet(Trial,gStates,stc,sub_fet,...
                                    [],[],nNeurons,nIter, ...
...
save(fullfile(Trial.spath,'req20160310_3_trainNN'),'out','-v7.3');
