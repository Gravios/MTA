% MjgER2016_figure_thetaPhasePrecession_drzCorrectedPhasePreference.m
%
...
% $$$             statesTPP);
tpp.ce = cf(@(s)                                                             ...
            cf(@(T,u) MTAApfs(T,u,'tag',['ddtp2-','s',num2str(sigma),'-',s]), ...
               Trials,                                                       ...
               units),                                                       ...
            statesTPP);
%%%>>>
...
validPosOccRr(ismember(cluSessionMapSubset,rind,'rows')) = false;
validUnits(ismember(cluSessionMapSubset,bind,'rows')) = false;
validUnits(ismember(cluSessionMapSubset,eind,'rows')) = false;
validUnits(ismember(cluSessionMapSubset,lind,'rows')) = false;
validUnits(ismember(cluSessionMapSubset,dind,'rows')) = false;
...
% $$$         plot(pftHZTPD{statesIndsGPE(s)}{t},u,1,'',[0,mrateHZTPD],false,[],[],[],@jet,[],nanColor);         
% $$$     end
% $$$     subplot(155);
% $$$         hold('on');        
% $$$         for s = 1:3,
