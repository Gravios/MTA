...
egoHbaPhzRmaps = load(fullfile(Trials{1}.path.project,'analysis','EgoProCode2D_compute_egoratemaps_cond_hba_x_phz_ptraj_maze2pfc_DATA_theta.mat'));

egoHbaPhzRmaps = load(fullfile(Trials{1}.path.project,'analysis','EgoProCode2D_compute_egoratemaps_cond_hba_x_phz_ptraj_maze2pfc_DATA_fine_theta.mat'));
...
% $$$ 
% $$$ 
% $$$ [t,p] = ttest2(egoHbaPhz.control.meanPos(unitsEgoCA1,3,2,2), ...
...
% $$$     end
% $$$ end
% $$$ egoHbaPhz.boot.ca1.sig = (1-(1-0.05)^(1/numel(unitsEgoCA1)));
