function ant_fig(Trial,varargin)
...
while 1,
    ...
    switch display_mode
      ...
      case 'report'
        ...
        reportfig(2993,[Trial.filebase '.ccg.ant_fig'],[],['unit: ' num2str(unit)],[],0);
        print(2993,'-depsc2','-r200',['/data/homes/gravio/mrep/ant_figs/' ...
                            Trial.name '\' Trial.name '.ant_fig.' num2str(unit)])
