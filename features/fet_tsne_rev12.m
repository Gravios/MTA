...
%% ANG Vel
ang_b_vel = [abs(circ_dist(circshift(fang(:,3,4,2),-round(0.1.*fang.sampleRate)),...
                           circshift(fang(:,3,4,2),round(0.1.*fang.sampleRate)))),...
             abs(circ_dist(circshift(fang(:,1,4,1),-round(0.2.*fang.sampleRate)),...
                           circshift(fang(:,1,4,1),round(0.2.*fang.sampleRate)))),...
             abs(circ_dist(circshift(fang(:,'bcom','hcom',1),-round(0.2.*fang.sampleRate)),...
                           circshift(fang(:,'bcom','hcom',1),round(0.2.*fang.sampleRate))))];
