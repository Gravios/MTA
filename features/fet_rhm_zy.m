function [rhm,varargout] = fet_rhm_zy(Trial,varargin)
...
rb = xyz.model.rb({'BR','BL','FR','FL'});
% find the center of mass of the model
hcom = xyz.com(rb);
% add coordinates of the model's center of mass to the xyz object
xyz.addMarker('fhcom',[.7,1,.7],{{'BR','FR',[0,0,1]}},ButFilter(hcom,3,[3]./(xyz.sampleRate/2),'low'));
xyz.addMarker('hcom',[128,255,128],{{'BR','FR',[0,0,1]}},hcom);
