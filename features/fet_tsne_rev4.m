function [fet,featureTitles,featureDesc,Nmean,Nstd] = fet_tsne_rev4(Trial,varargin)
...
fet.data = [fxyz(:,{'spine_lower','spine_middle','spine_upper','hcom'},3),...
            fang(:,1,4,3).*cos(fang(:,1,4,2)),...                       %Intermarker Distance
            fvelxy(:,{'spine_lower','spine_upper','hcom'}),...
            fvelz(:,{'spine_upper'}),...
            man.data+.2,...
            bfet.data,...
            zfet.data,...
            ...
            fang(:,'spine_upper','hcom',2),...                      %Pitch
            ang_b_vel,...
            abs(circ_dist(fang(:,1,3,1),circ_mean([fang(:,1,5,1),fang(:,1,7,1)],[],2))),...
            fang(:,'spine_lower','hcom',3)];%rhm.data
