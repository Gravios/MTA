function [rhm,varargout] = fet_head(Trial,varargin)
...
fet = xyz.copy;
bang = [ang(:,'head_back','fhcom',3),ang(:,'head_left','fhcom',3),ang(:,'head_front','fhcom',3),...
       ang(:,'head_right','fhcom',3),ang(:,'head_top','fhcom',3)];
