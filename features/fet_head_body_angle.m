function [fet,featureTitles,featureDesc] = fet_head_body_angle(Trial,varargin)
...
hbang.data = circ_dist(circ_dist(hbang.data(:,2),hbang.data(:,1)), -Trial.meta.correction.headBody);
