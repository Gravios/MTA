function [fet,featureTitles,featureDesc,Nmean,Nstd] = fet_bref_SMSU(Trial,varargin)
...
shft = 3;
tmar = {'spine_middle','spine_upper','head_back','head_front'};
...
mvec = xyz(:,'hcom',[1,2])-xyz(:,'spine_middle',[1,2]);
