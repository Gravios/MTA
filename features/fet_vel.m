...
%figure,plot(X*V(:,1))
% $$$ 
% $$$ Xa = zeros(vel.size(1),nembed);
% $$$ for i = 1:vel.size(2),
% $$$ Xa(:,:,i) = GetSegs(vel(:,i),1:vel.size(1),nembed,0)'/sqrt(N)*V(:,:);
% $$$ end
% $$$ Xa(nniz(Xa),:) = unity(Xa(nniz(Xa),:));
% $$$ 
% $$$ Na = zeros(vel.size(1),nembed);
% $$$ for i = 1:ncp.size(2),
% $$$ Na(:,:,i) = GetSegs(ncp(:,i),1:ncp.size(1),nembed,0)'/sqrt(N)*V(:,:);
% $$$ end
...
% $$$ linkaxes(sp,'xy')
% $$$ 
% $$$ Xa = GetSegs(vel(:,i),1:vel.size(1),nembed,0)'/sqrt(N)*V(:,5:14);
% $$$ Na = GetSegs(ncp(:,i),1:ncp.size(1),nembed,0)'/sqrt(N)*V(:,5:14);
...
figure,hist2([log10(abs(Xa(nniz(mXa)&nniz(vel),1))),log10(vXa(nniz(mXa)&nniz(vel)))],100,100);caxis([0,500])
...
figure,hist2([mXa(nniz(mXa)&nniz(vel),1),vXa(nniz(mXa)&nniz(vel))],100,100);caxis([0,500])

figure,hist2([log10(abs(Xa(nniz(mXa)&nniz(vel)&wper.data,1))),log10(vXa(nniz(mXa)&nniz(vel)&wper.data))],linspace(-1.5,1.5,100),linspace(-3,1,100));caxis([0,500])

figure,hist2([log10(abs(mXa(nniz(mXa)&nniz(vel)&~wper.data&~rper.data,1))),log10(vXa(nniz(mXa)&nniz(vel)&~wper.data&~rper.data))],linspace(-3,.5,100),linspace(-4,.5,100));caxis([0,500])

figure,hist2([log10(abs(mXa(nniz(mXa)&nniz(vel)&~wper.data&~rper.data,1))),log10(vXa(nniz(mXa)&nniz(vel)&~wper.data&~rper.data))],linspace(-3,.5,60),linspace(-4,.5,60));caxis([0,1000])

figure,hist2([log10(abs(mXa(nniz(mXa)&nniz(vel)&~wper.data,1))),log10(vXa(nniz(mXa)&nniz(vel)&~wper.data))],linspace(-3,.5,60),linspace(-4,.5,60));caxis([0,1000])
