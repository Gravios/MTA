function [fet,featureTitles,featureDesc,Nmean,Nstd] = fet_bref_rev5(Trial,varargin)
...
fmdwalkSegs = GetSegs([reshape(fmdwalkFetRot.data,size(xyz,1),[])], ...  x
                    ...
                    round(xyz.sampleRate),                          ...  segments' lengths
                    0                                               ...  If not complete
);
