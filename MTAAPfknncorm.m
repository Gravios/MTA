classdef MTAAPfknncorm < hgsetget %< MTAAnalysis
    properties 
        path
        filename = '';
        session
    ...
    methods
        ...
        function Pfs = MTAAPfknncorm(Obj, varargin)     
        ...
        function Pfs = updateFilename(Pfs,Session,varargin)
            ...
            if isempty(Pfs.tag)
                ...
                Pfs.filename = [Session.filebase ...
                    '.pfknncorm.' Pfs.parameters.type '.' Session.trackingMarker '.' pfsState.label '.' ...
                ...
                Pfs.filename = [Session.filebase '.pfknncorm.' Pfs.tag '.mat'];
            end
        end
