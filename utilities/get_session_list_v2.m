...
switch sessionList
  case 'FS10'
    dxyz   = fullfile(datPath,'data/processed/xyz/FS10');
    dephys = fullfile(datPath,'data/processed/ephys/FS10');
    % FS10 1-2 --------------------------------------------------------------------------
    my_xyz = fullfile(my_xyz,'FS10');
    Sessions(1) = struct('sessionBase',  'FS10',                                      ...
                         'sessionName',  'FS10-20220216a',                            ...
                         'primarySubject','FS10',                                     ...
                         'subjects',     {{'FS10'}},                                  ...
                         'subject',      struct('name','FS10',                        ...
                                                'correction',                         ...
                                                      struct('thetaPhase', 0,         ...
                                                             'headYaw',   0,          ...
                                                             'headBody',  0,          ...
    ...
    Sessions(end).sessionName = 'FS10-20220217a';
...
% $$$     );
  ...
  case 'Trials-ER06'
    dxyz   = fullfile(datPath,'data/processed/xyz/ER06');
    dephys = '/storage/evgeny/data/processed/ER06';    
    Sessions(1) = struct('sessionBase',  'ER06',                                      ...
                         'sessionName',  'ER06-20130613',                             ...
                         'primarySubject','ER06',                                     ...
                         'subjects',     {{'ER06'}},                                  ...
    ...
    Sessions(end+1)                              = Sessions(end);
    Sessions(end).trialName                      = 'trn';
    Sessions(end).includeSyncInd                 = [ 3, 4];
    Sessions(end+1)                              = Sessions(end);
    Sessions(end).trialName                      = 'nvl';
    Sessions(end).includeSyncInd                 = [ 5,6];

    Sessions(end+1)                              = Sessions(end);    
    Sessions(end).sessionName                    = 'ER06-20130612';
    Sessions(end).trialName                      = 'bhv';    
    ...
    Sessions(end+1)                              = Sessions(end);
    Sessions(end).trialName                      = 'nvl';    
    Sessions(end).includeSyncInd                 = [6,7];

    Sessions(end+1)                              = Sessions(end);
    Sessions(end).sessionName                    = 'ER06-20130614';
    Sessions(end).trialName                      = 'gnd1';
    Sessions(end).includeSyncInd                 = [1:3];
    Sessions(end+1)                              = Sessions(end);
    Sessions(end).trialName                      = 'gnd2';
    Sessions(end).includeSyncInd                 = [7,8];
    Sessions(end+1)                              = Sessions(end);
    Sessions(end).trialName                      = 'gnd3';
    Sessions(end).includeSyncInd                 = [11,12];
