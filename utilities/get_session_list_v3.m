function Sessions = get_session_list_v3(sessionList,varargin)
...
% >>> setup_ec16 >>> ----------------------------------------------------------
  case 'setup_ec16'
    ...
    tmy_xyz = my_xyz;
    Sessions(1) = struct(                                                   ...
        'sessionName',  'ec16-00577590',                                    ...
        'subjects',     {{'ec16'}},                                         ...
        'subject',      struct('name','ec16',                               ...
                               'correction',   struct('thetaPhase',-0.5,    ...
                                                      'headYaw',    0,      ...
                                                      'headBody',   0,      ...
                                                      'headRoll',   0),     ...
                               'channelGroup', struct('theta',  4,          ...
                                                      'thetarc', [1,8],     ...
                                                      'ripple',  [1:8])),   ...
        'mazeName',     'sof',                                              ...
        'trialName',    'all',                                              ...
        'dLoggers',     {{'nlx','whl'}},                                    ...
        'dPaths',       struct('xyz', '/storage/gravio/data/processed/ephys/ec16/', ...
...
% <<< ncp <<< -----------------------------------------------------------------
  ...
  case 'ER06-spots',
    my_xyz = '/storage/evgeny/data/processed/ER06';
    my_nlx = '/storage/evgeny/data/processed/ER06';
    ...
    Sessions(1) = struct('sessionName',  'ER06-20130613',                             ...
                         ...
                         'dPaths',                                                    ...
                             struct('xyz', my_xyz,                                    ...
                                    'nlx', my_nlx),                                   ...
                         'xyzSampleRate', 50.0000,                                    ...
                         'hostServer',   'lmu',                                       ...
                         'dataServer',   'lmu',                                       ...
                         'project',      'general',                                   ...
                         'TTLValue',     'Starting Recording',                        ...
                         'includeSyncInd',[],                                         ...
                         'offsets',       [0,0],                                      ...
                         'xOffset',       0,                                          ...
                         'yOffset',       0,                                          ...
  ...
  case 'ER06-20130613-spots'
    ...
    Sessions(end+1) = Sessions(end);
    Sessions(end).trialName = 'tmz';
    

% >>> BehaviorPlaceCode >>> ---------------------------------------------------
  case 'BehaviorPlaceCode',
    tmy_nlx = my_nlx;
    tmy_xyz = my_xyz;
    % >>> er01 1-3   >>>
...
% >>> ER06 4-8   >>>
    ...
    Sessions(end).subject.channelGroup.thetarc   = [17,24];
    Sessions(end).subject.channelGroup.ripple    = [9:16];
    Sessions(end).subject.anat_loc.CA1           = true;
    Sessions(end).subject.anat_loc.CA3           = false;
    Sessions(end).dPaths         = struct('xyz', my_xyz,'nlx', my_nlx);
    Sessions(end).xyzSampleRate  = 199.997752;
    Sessions(end).TTLValue       = 'Vicon start';
    ...
    Sessions(end+1) = Sessions(end);    
    Sessions(end).sessionName    = 'ER06-20130624';
    Sessions(end).trialName      = 'all';
    Sessions(end).includeSyncInd = [];
    Sessions(end).subject.correction.thetaPhase = 3*pi/4;
    Sessions(end).subject.channelGroup.theta = 48;
    Sessions(end).subject.channelGroup.thetarc = [49,56];
    Sessions(end).subject.channelGroup.ripple = 17:24;
    Sessions(end).subject.anat_loc.CA3           = true;
    Sessions(end).subject.anat_loc.CA1           = false;
    Sessions(end).xOffset = -20;
    Sessions(end).yOffset = -20;
    Sessions(end+1) = Sessions(end);
    Sessions(end).sessionName    = 'ER06-20130625';
% <<< ER06 4-8 <<<
% >>> Ed10 9-13  >>>
