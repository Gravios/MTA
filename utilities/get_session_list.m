...
% EXTRA SESSIONS -------------------------------
    ...
    Sessions(end).thetaRef     = [8:8:32,40,47,53,59,repmat(73,[1,4])];
    Sessions(end).thetaRefGeneral = 70;    
    Sessions(end).offsets      = [12,0];
    Sessions(end).rippleDetectionChannels = [49:56];
    ...
    Sessions(end).thetaRef     = [8:8:32,40,47,53,59,repmat(73,[1,4])];
    Sessions(end).thetaRefGeneral = 71;    
    Sessions(end).offsets      = [12,0];
    Sessions(end).rippleDetectionChannels = [49:56];
