...
%
% Stc:   (MTAStateCollection)   Empty collection 
%        (string)               contains the mode assigned to the output
%
% Trial: (MTATrial)             Trial(s) of Stcs' for labeling
%        (string)               list of sessions found in get_session_list.m 
%
% Default Arguments 
%   varargin:
%     sessionList              (String,MTASession)           ''
%     featureSet               (String)                      'fet_mis'
...
%     dropIndex                (NumericArray)                2
%     prctTrain                (Numeric)                     90
%

% DEFARGS -----------------------------------------------------------------------------------------
defArgs = struct('sessionList',                 Trial,                                          ...
                 'featureSet',                  'fet_mis',                                      ...
