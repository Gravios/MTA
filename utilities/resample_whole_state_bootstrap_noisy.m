function [StcRnd,labelingEpochs,trainingFeatures] = resample_whole_state_bootstrap_noisy(StcHL,features,states,varargin)
...
trainingFeatures.data = trainingFeatures.data+randn(trainingFeatures.size)/10;
